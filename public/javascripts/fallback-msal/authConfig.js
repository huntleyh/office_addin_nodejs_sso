...
const clientId = "b274b65f-e0aa-4113-94a7-adb21c4a118d";
 ...
 */
 ...
 const msalConfig = {
    auth: {
      ...
      redirectUri: "https://office-sso.azurewebsites.net/dialog.html", // You must register this URI on Azure Portal/App Registration. Defaults to window.location.href
      //postLogoutRedirectUri: "https://office-sso.azurewebsites.net/signout", // Simply remove this line if you would like navigate to index page after logout.
